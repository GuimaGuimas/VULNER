...
public class PessoaClienteDAO {
    ...
    public void insertPessoaCliente(PessoaCliente pessoaCliente) throws SQLException {
        String sql = "INSERT INTO pessoaCliente (nome, email, senha, cpf, dtNascimento, enderecoEnderecoId)" +
        ...
        ps.setString(5, pessoaCliente.getDtNascimento());
    ...
    public void updatePessoaCliente(PessoaCliente pessoaCliente) throws SQLException {
        String sql = "UPDATE PessoaCliente SET nome = :1 , email = :2 , senha = :3 , cpf = :4 , dtNascimento = TO_DATE(:5 , 'YYYY/MM/DD'), enderecoEnderecoId = :6 WHERE pessoaClienteId = :7";
        PreparedStatement ps = pessoaClienteConexao.prepareStatement(sql);
    ...
    public ArrayList<PessoaCliente> readPessoaClientes() throws SQLException {
        String sql = "SELECT pessoaClienteId, nome, email, cpf, dtNascimento, enderecoEnderecoId FROM PessoaCliente";
        PreparedStatement ps = pessoaClienteConexao.prepareStatement(sql);
        ...
        while (result.next()) {
            ...
            pessoaCliente.setDtNascimento(result.getString("dtNascimento"));
